                ...
                .AddPanel<SplitResizablePanel>("Main Panel")
                    ...
                    .GetRightOrBottomPanel<ScrollablePanel>("Images")
                        ...
                        .GetScrollingPanel<PlainPanel>()
                            .SetGridLayout(TextAnchor.UpperCenter, GridLayoutGroup.Corner.LowerLeft, GridLayoutGroup.Axis.Horizontal, new RectOffset(20, 10, 10, 10), 20, 20, new Vector2(100, 100)) // Figures refer to padding and spacing
        ...
        public void AddBottomMenuBar(InterfaceSlide slide) {
            ...
            slide
                .AddPanel<PlainPanel>("MenuBar", out menuPanel_firstWay)
                    ...
                    .SetColour(0.2f)
                    .Process((menuPanel_secondWay) => AddButton(menuPanel_secondWay, "Close", () => CloseInterface()))
                    .Process((p) => 
