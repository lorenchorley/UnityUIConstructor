...
namespace UnityUIConstructor {
    ...
    public class SplitResizablePanel : InterfacePanel {
        ...
        protected override void Setup() {
            ...
            Coordinator.OnFinishGeneratingInterface.AddListener(delegate {
                // Finalise settings
        ...
        public P GetLeftOrTopPanel<P>(string name = null) where P : InterfacePanel {
            P panel;
        ...
        public P GetRightOrBottomPanel<P>(string name = null) where P : InterfacePanel {
            P panel;
        ...
        private ResizeControl SetResizableControl(float size, bool updateContinuously) {
            ...
            Coordinator.OnInterfaceConfigured.AddListener(() => control.UpdatePosition());
            return control;
        }
